...
export function Sidebar() {
  const {
    ...
    userApiKey,
    setUserApiKey,
    userAnthropicApiKey, // <-- Get Anthropic key
    setUserAnthropicApiKey, // <-- Get Anthropic setter
    selectedProvider,
    setSelectedProvider,
    selectedModel,
    setSelectedModel,
  ...
  // --- UPDATED: Logic to get the CURRENT provider's key state ---
  ...
  // --- UPDATED: Logic to get the CURRENT provider's key setter ---
  ...
  return (
    <>
      ...
      <aside className="w-64 bg-gray-50 p-4 border-r border-gray-200 overflow-y-auto flex-shrink-0 flex flex-col">
        ...
        <div className="mb-6 space-y-2 flex-shrink-0 border-t pt-4">
          {' '}
          {/* Added separator */}
          <label
          ...
          <button
            ...
            title={
              selectedTemplateToLoad
                ? `Delete selected template "${selectedTemplateToLoad}"`
            ...
            <div>
              <button
                ...
                className={`w-full text-sm py-2 px-3 rounded transition duration-150 ease-in-out ${
                  currentProviderApiKey // Use key for CURRENT provider
